...
const ThreadRoot = () => {
  ...
  return (
    <ThreadPrimitive.Root
      className="aui-root aui-thread-root bg-[rgb(249, 245, 237)] flex h-full w-full flex-col overflow-hidden relative"
      style={{
    ...
    >
      ...
      >
        <div className="mx-auto flex w-full max-w-(--thread-max-width) min-h-full flex-col items-center px-4 pt-24 pb-44">
          ...
          <div
            ...
            className="flex w-full flex-col gap-y-6 empty:hidden"
          >
      ...
      {/* Floating Input Box Container - Fixed 50px from bottom */}
      <div className="absolute bottom-[40px] left-0 right-0 w-full flex flex-col items-center justify-center px-4 sm:px-6 z-30 pointer-events-none">
        <div className="flex w-full max-w-(--thread-max-width) flex-col items-center justify-center gap-2 relative pointer-events-auto">
